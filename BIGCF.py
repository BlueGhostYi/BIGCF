...
class BIGCF(nn.Module):
    ...
    def inference(self):
        ...
        return all_embeddings, int_embeddings
    ...
    def cal_ssl_loss(self, users, items, gnn_emb, int_emb):
        ...
        u_gnn_embs, i_gnn_embs = torch.split(gnn_emb, [self.n_users, self.n_items], 0)
        u_int_embs, i_int_embs = torch.split(int_emb, [self.n_users, self.n_items], 0)
